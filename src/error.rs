...
pub enum ErrorCode {
    ...
    ObsoleteReadAfterOptimeTimeout = 122,
    NotAReplicaSet = 123,
    ...
    XxxTempNameReadCommittedCurrentlyUnavailable = 134,
    StaleTerm = 135,
...
impl ErrorCode {
    ...
    fn to_str(&self) -> &str {
        match *self {
            ...
            ErrorCode::ObsoleteDuplicateKey => "OBSOLETE_DuplicateKey",
            ...
            ErrorCode::ObsoleteReadAfterOptimeTimeout => "OBSOLETE_ReadAfterOptimeTimeout",
            ...
            ErrorCode::XxxTempNameReadCommittedCurrentlyUnavailable => "XXX_TEMP_NAME_ReadCommittedCurrentlyUnavailable",
